...
<!-- STATS:START -->
> **Generated:** 2026-09-09 00:43 UTC  
...
| Total Issues | **2792** |
| Open Issues | 44 (1.6%) |
| Closed Issues | 2748 (98.4%) |
| Unique Contributors | 379 |
| Distinct Labels | 18 |
| Total Label Assignments | 5544 |
| First Issue | 2025-05-05 |
| Latest Issue | 2026-09-08 |

## Label Statistics

| Label | Count | % of All Issues |
|-------|------:|----------------:|
| `data request` | 2750 | 98.5% |
| `completed` | 2096 | 75.1% |
| `failed` | 379 | 13.6% |
| `invalid` | 192 | 6.9% |
| `aborted` | 31 | 1.1% |
...
|------------|------:|------------:|
| Closed within 1 day | 289 | 10.5% |
| Closed within 7 days | 2390 | 87.0% |
| Closed within 30 days | 2732 | 99.4% |
...
| Metric | Value |
|--------|-------|
| Average Issues / Month | 164.2 |
| Peak Month | 2026-06 — 404 issues |
| Quietest Month | 2026-09 — 47 issues |
...
| Labels | Count |
|--------|------:|
| `completed` + `data request` | 2074 |
| `data request` + `failed` | 359 |
| `data request` + `invalid` | 190 |
...
*Statistics generated by `extract_statistics.py` on 2026-09-09 00:43 UTC.*
<!-- STATS:END -->
