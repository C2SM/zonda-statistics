...
<!-- STATS:START -->
> **Generated:** 2026-08-23 00:20 UTC  
...
| Total Issues | **2698** |
| Open Issues | 48 (1.8%) |
| Closed Issues | 2650 (98.2%) |
| Unique Contributors | 371 |
| Distinct Labels | 18 |
| Total Label Assignments | 5356 |
| First Issue | 2025-05-05 |
| Latest Issue | 2026-08-22 |

## Label Statistics

| Label | Count | % of All Issues |
|-------|------:|----------------:|
| `data request` | 2656 | 98.4% |
| `completed` | 2024 | 75.0% |
| `failed` | 376 | 13.9% |
| `invalid` | 173 | 6.4% |
| `aborted` | 31 | 1.1% |
...
|------------|------:|------------:|
| Closed within 1 day | 284 | 10.7% |
| Closed within 7 days | 2294 | 86.6% |
| Closed within 30 days | 2634 | 99.4% |

## Top Contributors (by Issues Opened)

| Rank | User | Issues | % of Total |
|-----:|------|-------:|-----------:|
| 1 | [stelliom](https://github.com/stelliom) | 146 | 5.4% |
...
| 8 | [jvicenciov](https://github.com/jvicenciov) | 43 | 1.6% |
...
| 12 | [Chao123-cyber](https://github.com/Chao123-cyber) | 36 | 1.3% |
...
| Labels | Count |
|--------|------:|
| `completed` + `data request` | 2002 |
| `data request` + `failed` | 356 |
| `data request` + `invalid` | 171 |
...
*Statistics generated by `extract_statistics.py` on 2026-08-23 00:20 UTC.*
<!-- STATS:END -->
