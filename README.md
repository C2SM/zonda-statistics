...
| Total Issues | **2359** |
| Open Issues | 144 (6.1%) |
| Closed Issues | 2215 (93.9%) |
| Unique Contributors | 349 |
| Distinct Labels | 16 |
| Total Label Assignments | 4692 |
| First Issue | 2025-05-05 |
| Latest Issue | 2026-06-29 |

## Label Statistics

| Label | Count | % of All Issues |
|-------|------:|----------------:|
| `data request` | 2331 | 98.8% |
| `completed` | 1764 | 74.8% |
| `failed` | 356 | 15.1% |
| `invalid` | 140 | 5.9% |
| `aborted` | 31 | 1.3% |
...
| Closed within 7 days | 1861 | 84.0% |
| Closed within 30 days | 2200 | 99.3% |
...
| 8 | [LudovicoMattavelli](https://github.com/LudovicoMattavelli) | 39 | 1.7% |
...
| Metric | Value |
|--------|-------|
| Average Issues / Month | 168.5 |
| Peak Month | 2026-06 — 401 issues |
...
| Labels | Count |
|--------|------:|
| `completed` + `data request` | 1743 |
| `data request` + `failed` | 338 |
| `data request` + `invalid` | 139 |
...
*Statistics generated by `extract_statistics.py` on 2026-06-30 01:04 UTC.*
<!-- STATS:END -->
