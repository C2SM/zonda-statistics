...
| Total Issues | **2739** |
| Open Issues | 54 (2.0%) |
| Closed Issues | 2685 (98.0%) |
| Unique Contributors | 375 |
| Distinct Labels | 18 |
| Total Label Assignments | 5438 |
...
| Closed within 7 days | 2329 | 86.7% |
| Closed within 30 days | 2669 | 99.4% |
...
| Labels | Count |
|--------|------:|
| `completed` + `data request` | 2032 |
| `data request` + `failed` | 357 |
| `data request` + `invalid` | 181 |
...
*Statistics generated by `extract_statistics.py` on 2026-08-29 00:39 UTC.*
<!-- STATS:END -->
