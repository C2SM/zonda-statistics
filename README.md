...
<!-- STATS:START -->
> **Generated:** 2026-09-22 00:43 UTC  
...
| Total Issues | **2847** |
| Open Issues | 28 (1.0%) |
| Closed Issues | 2819 (99.0%) |
| Unique Contributors | 386 |
| Distinct Labels | 18 |
| Total Label Assignments | 5653 |
| First Issue | 2025-05-05 |
| Latest Issue | 2026-09-21 |

## Label Statistics

| Label | Count | % of All Issues |
|-------|------:|----------------:|
| `data request` | 2803 | 98.5% |
| `completed` | 2149 | 75.5% |
| `failed` | 379 | 13.3% |
| `invalid` | 193 | 6.8% |
| `aborted` | 32 | 1.1% |
...
|------------|------:|------------:|
| Closed within 1 day | 305 | 10.8% |
| Closed within 7 days | 2461 | 87.3% |
| Closed within 30 days | 2803 | 99.4% |

## Top Contributors (by Issues Opened)

| Rank | User | Issues | % of Total |
|-----:|------|-------:|-----------:|
| 1 | [stelliom](https://github.com/stelliom) | 149 | 5.2% |
...
| 8 | [jvicenciov](https://github.com/jvicenciov) | 47 | 1.7% |
...
| Metric | Value |
|--------|-------|
| Average Issues / Month | 167.5 |
| Peak Month | 2026-06 — 404 issues |
| Quietest Month | 2026-09 — 102 issues |
...
| Labels | Count |
|--------|------:|
| `completed` + `data request` | 2126 |
| `data request` + `failed` | 359 |
| `data request` + `invalid` | 191 |
...
*Statistics generated by `extract_statistics.py` on 2026-09-22 00:43 UTC.*
<!-- STATS:END -->
