...
<!-- STATS:START -->
> **Generated:** 2026-09-04 00:41 UTC  
...
| Total Issues | **2767** |
| Open Issues | 41 (1.5%) |
| Closed Issues | 2726 (98.5%) |
| Unique Contributors | 377 |
| Distinct Labels | 18 |
| Total Label Assignments | 5494 |
| First Issue | 2025-05-05 |
| Latest Issue | 2026-09-03 |

## Label Statistics

| Label | Count | % of All Issues |
|-------|------:|----------------:|
| `data request` | 2725 | 98.5% |
| `completed` | 2076 | 75.0% |
| `failed` | 379 | 13.7% |
| `invalid` | 187 | 6.8% |
| `aborted` | 31 | 1.1% |
...
|------------|------:|------------:|
| Closed within 1 day | 286 | 10.5% |
| Closed within 7 days | 2369 | 86.9% |
| Closed within 30 days | 2710 | 99.4% |

## Top Contributors (by Issues Opened)

| Rank | User | Issues | % of Total |
|-----:|------|-------:|-----------:|
| 1 | [stelliom](https://github.com/stelliom) | 147 | 5.3% |
| 2 | [janisklamt](https://github.com/janisklamt) | 95 | 3.4% |
| 3 | [mjaehn](https://github.com/mjaehn) | 56 | 2.0% |
...
| 7 | [criess374](https://github.com/criess374) | 51 | 1.8% |
...
| 15 | [ChristianSteger](https://github.com/ChristianSteger) | 32 | 1.2% |
...
| Metric | Value |
|--------|-------|
| Average Issues / Month | 162.8 |
| Peak Month | 2026-06 — 404 issues |
| Quietest Month | 2026-09 — 22 issues |
...
| Labels | Count |
|--------|------:|
| `completed` + `data request` | 2054 |
| `data request` + `failed` | 359 |
| `data request` + `invalid` | 185 |
...
*Statistics generated by `extract_statistics.py` on 2026-09-04 00:41 UTC.*
<!-- STATS:END -->
